...
import {
  ...
  UserCheck, Activity, Bot, BarChart3, FileSpreadsheet, LogOut, Menu, X, ArrowLeft, Share2
} from 'lucide-react';
...
export default function AdminLayout() {
  ...
  const navItems = [
    ...
    { path: '/admin/social-commerce', icon: Share2, label: lang === 'ar' ? 'التجارة الاجتماعية (Meta)' : 'Social Commerce (Meta)' },
